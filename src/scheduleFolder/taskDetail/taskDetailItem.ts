...
export function createTaskDetailPage(){
    let taskPageWrapper = <HTMLDivElement> document.querySelector(".taskDetailDivWrapper")
...
export class ProjectItem implements ProjectItemInterface {
    name: string
    type: string
    uniqueID: string
    description: string
    ...
    constructor(jsonObject: {name?: string, type?:string, uniqueID?: string, description?: string, status?: string, date?: string, reward?: number, taskArray?: TaskItemInterface[]}){
    ...
    addItem(taskItem:TaskItemInterface){
    ...
    removeItem(taskItemUniqueID:string){
...
export class TaskItem implements TaskItemInterface {
    ...
    constructor(jsonObject: {name: string, type: string, uniqueID: string, description: string, status: string, date: string, reward: number}){
