...
export function GNBookmark(createData: CreateGreatNoteObjectInterface):GNBookmarkInterface {
    let {name, arrayID, insertPosition, dataPointer, saveToDatabase, specialCreationMessage, injectedData, _classNameList} = createData

    let _object = <GNBookmarkInterface> document.createElement("div");
    ...
    return <GNBookmarkInterface>  _object
}
