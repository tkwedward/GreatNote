...
import {communicationDataStructure, MainControllerInterface, mainArrayData} from "./mainControllerFolder/mainControllerInterface"
...
// ******************************************
    ...
    getObjectById(objectID, doc=this.mainDoc){
        ...
        if (targetElement) return targetElement["objectData"]
