...
export function superController(controllerContainer: any){
  // to add some function and common properties to an controller object
    ...
    controllerContainer.responseToHtmlType = function (htmlObject:any){
      ...
      //** ??? don't understand
      controllerContainer.attachTo = function (htmlObject: any){
...
// e.g. for
export function universalControllerCreater(name:string, controllerOptions: LengthControllerOptionInterface|DropdownListControllerOptionInterface): any{
