...
// @auto-fold heres
export function inputFieldAndDropdownListController(attributeName: string, unitOptions: any){
    ...
    unitOptions.forEach((unit:string)=>{
...
export function dropdownListController(attributeName:string, selectionList:string[]):DropdownListControllerInterface{
    ...
    // functions
    controllerContainer.setControllerTarget = function (object:any){
        controllerContainer.controllerTarget = object
    }
...
// @auto-fold here
export function choiceController(attribute:string, choiceList:any, prototype:HTMLElement): ChoiceControllerInterface{
    ...
    choiceList.forEach((choiceValue:any)=>{
    ...
    /** to update the value according to the controller values */
    controllerContainer.updateObject = function (itemValue): void{
        if (controllerContainer.controllerTarget){
