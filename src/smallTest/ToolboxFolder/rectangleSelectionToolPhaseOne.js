import { clearUpEvent, getOffSetXY, mousePositionRatioAdjustment } from "./toolBoxHelperFunction";
import * as Settings from "../settings";
import { checkCornersInside, checkSideInsideRect, getPointWidthAndHeight, addEventToSelectionRect } from "./rectangleSelectionHelperFunction";
let strokeColor = "blue";
let strokeWidth = "2px";
export function selectionToolPhaseOneMouseDownFunction(e, mainController, overlay, moveEventName, upEventName) {
