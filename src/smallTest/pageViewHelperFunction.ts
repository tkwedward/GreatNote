...
export function createNewPage(pageController: any, fullPageModeDiv:HTMLDivElement, overviewModeDiv:HTMLDivElement, fullPageData?:any, overviewPageData?:any, saveToDatabase=true){
    let newPage = GNPage({
