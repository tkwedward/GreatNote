...
export function addFunctionToSmallViewHTMLObject(smallViewHTMLObject:HTMLDivElement){
    console.log(smallViewHTMLObject)
    smallViewHTMLObject.draggable = true


    smallViewHTMLObject.addEventListener("click", e=>{
      let selectedSmallViewHTMLObject = <HTMLDivElement> overviewModeDiv.querySelector(".selectedSmallViewHTMLObject")
      if (selectedSmallViewHTMLObject) selectedSmallViewHTMLObject.classList.toggle("selectedSmallViewHTMLObject")
